...
Projeto pessoal desenvolvido para praticar desenvolvimento de aplicações, operações CRUD e integração com banco de dados.
...
Busco uma oportunidade em tecnologia para aplicar meus conhecimentos, adquirir experiência profissional e continuar evoluindo na área de desenvolvimento de software.
